                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Customer</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{url('customers')}}">Customer List</a>
                                <a class="dropdown-item" href="{{url('customers/add')}}">New Customer</a>
                            </div>
                        </a>
                        </li>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Product</a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{url('products/add')}}">New Product</a>
                            </div>
                        </a>
                        </li>
